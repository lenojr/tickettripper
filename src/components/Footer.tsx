        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm max-w-xs">
              ...
              Book your next journey with us today.
            </p>
          </div>
          ...
          <div>
            <h3 className="font-semibold mb-4 text-sm uppercase tracking-wider text-muted-foreground">Support</h3>
            <ul className="space-y-3">
              <FooterLink to="/help">Help Center</FooterLink>
              <FooterLink to="/contact">Contact Us</FooterLink>
              <FooterLink to="/accessibility">Accessibility</FooterLink>
              <FooterLink to="/covid">COVID-19 Info</FooterLink>
            </ul>
          </div>
...
const FooterLink = ({ children, to }: { children: React.ReactNode; to: string }) => (
  <li>
    <Link to={to} className="text-sm text-foreground/80 hover:text-primary">
      {children}
    </Link>
  </li>
);

const SocialLink = ({ children, href, ...props }: { children: React.ReactNode; href: string, [key: string]: any }) => (
  <a 
    href={href} 
