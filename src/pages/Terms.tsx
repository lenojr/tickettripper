...
const Terms = () => {
  return (
    ...
    >
      <p>
        These Terms of Service ("Terms") govern your use of the LenojrBus website, mobile application, 
      ...
      <p>
        LenojrBus provides bus transportation services between various destinations. We also offer 
      ...
      <p>
        ...
        4.3. LenojrBus reserves the right to refuse service to anyone who does not have a valid ticket or 
      ...
      <p>
        ...
        6.2. LenojrBus is not responsible for any delays due to traffic, weather, or other circumstances beyond our control.<br />
      ...
      <p>
        ...
        and software, is the property of LenojrBus or its content suppliers and is protected by copyright 
        and other intellectual property laws.
      </p>
      
      <h2>8. Limitation of Liability</h2>
      <p>
        To the maximum extent permitted by law, LenojrBus shall not be liable for any indirect, incidental, 
      ...
      <p>
        You agree to indemnify and hold harmless LenojrBus, its affiliates, officers, directors, employees, 
      ...
      <p>
        LenojrBus reserves the right to modify these Terms at any time. We will provide notice of significant 
      ...
      <p>
        ...
        <a href="mailto:legal@lenojrbus.com" className="text-primary"> legal@lenojrbus.com</a>.
      </p>
