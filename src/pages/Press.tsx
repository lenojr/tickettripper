...
const Press = () => {
  return (
    ...
    >
      <p>
        Welcome to the LenojrBus press center. Here you'll find our latest news, press releases, 
      ...
      <div className="space-y-6 my-8">
        <div className="border-b pb-6">
          ...
          <h3 className="text-xl font-semibold my-2">lenojrBus Expands Service to 10 New Cities</h3>
          <p>
            LenojrBus announced today the expansion of its service network to include 10 new cities, 
        ...
        <div className="border-b pb-6">
          ...
          <h3 className="text-xl font-semibold my-2">lenojrBus Introduces New Eco-Friendly Fleet</h3>
          <p>
            As part of our commitment to sustainability, LenojrBus has invested in a new fleet of 
        ...
        <div className="border-b pb-6">
          ...
          <h3 className="text-xl font-semibold my-2">lenojrbusReports Record Growth in 2022</h3>
          <p>
            LenojrBus today announced record growth for 2022, with a 75% increase in ridership 
      ...
      <p>
        ...
        <a href="mailto:press@lenojrbus.com" className="text-primary">press@lenojrBusbus.com</a><br />
        (555) 123-4567
      </p>
